...
ejecutaServicio(function () {
 ...
 $modelo =
  selectFirst(pdo: Bd::pdo(),  from: VEHICULO,  where: [PAS_ID => $id]);
 ...
 if ($modelo === false) {
  ...
  throw new ProblemDetails(
   ...
   type: "/error/vehiculonoencontrado.html",
 ...
 devuelveJson([
  ...
  "numserie" => ["value" => $modelo[PAS_NUMSERIE]],
  "placas" => ["value" => $modelo[PAS_PLACAS]],
 ]);
});
